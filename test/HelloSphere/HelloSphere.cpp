  ...
  public:
    App() : rcube::Window("Hello sphere")
    {
        ...
        std::shared_ptr<Mesh> gridMesh =
            Mesh::create(rcube::grid(2, 2, 10, 10, glm::vec3(1.0, 0.0, 0.0),
        ...
        {
            std::shared_ptr<Mesh> sphereMesh = Mesh::create(cubeSphere(0.5, 10));
        ...
        // Create a plane
        {
            std::shared_ptr<Mesh> planeMesh =
                Mesh::create(plane(2, 2, 10, 10, rcube::Orientation::PositiveY));
        ...
        std::shared_ptr<Mesh> boxMesh = Mesh::create(box(1, 1, 1, 1, 1, 1));
        boxMesh->uploadToGPU();
        ...
        tex_blinnPhong->texture("diffuse_tex")
            ->setData(checkerboard(128, 128, 8, 8, glm::vec3(0, 0, 0), glm::vec3(1, 1, 1)));
