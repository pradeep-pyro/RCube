...
{
  public:
    BlinnPhongMaterial(glm::vec3 diffuse_color = glm::vec3(1.0),
                       glm::vec3 specular_color = glm::vec3(0.5f), float shininess = 4.f);
    ...
    float shininess;    /// Shininess is the specular exponent. Higher values result in smaller but
                        /// sharper highlights
    float reflectivity; /// Reflectivity [0.0, 1.0] controls the amount of reflection of the
                        /// environment map
    // Wireframe
