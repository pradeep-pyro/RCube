...
{
  public:
    float min_horizontal_angle; /// Minimum horizontal angle (radians) to constrain the camera
                                /// (default: -inf)
    float max_horizontal_angle; /// Maximum horizontal angle (radians) to constrain the camera
                                /// (default: +inf)
    float min_vertical_angle; /// Minimum vertical angle (radians) to constrain the camera (default:
                              /// -\pi)
    float max_vertical_angle; /// Maximum vertical angle (radians) to constrain the camera (default:
                              /// +\pi)
