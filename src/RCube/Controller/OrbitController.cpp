...
OrbitController::OrbitController()
    : min_horizontal_angle(-std::numeric_limits<float>::infinity()),
      max_horizontal_angle(std::numeric_limits<double>::infinity()), min_vertical_angle(0.1f),
      max_vertical_angle(glm::pi<float>() - 0.1f), orbiting_(false)
{
}
